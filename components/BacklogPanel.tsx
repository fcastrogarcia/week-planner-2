  ...
  return (
    <aside className={cn('flex flex-col min-h-0 bg-neutral-50 dark:bg-neutral-900', className)}>
      <div className="px-3 py-2 flex items-center justify-between">
        <h3 className="text-sm font-semibold tracking-wide text-neutral-600 dark:text-neutral-300">Backlog</h3>
      </div>
      <div
      ...
      >
        ...
        {backlog.length === 0 && <p className="text-xs text-neutral-400">Sin tareas pendientes en backlog.</p>}
        {backlog
